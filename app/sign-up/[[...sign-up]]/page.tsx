    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="w-full max-w-md p-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Únete a PushSaaS</h1>
          <p className="text-gray-600">Crea tu cuenta y comienza a reconectar con tus visitantes</p>
        </div>
        <SignUp 
          appearance={{
            elements: {
